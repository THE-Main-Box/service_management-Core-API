...
public class ConfigRefNames {
    ...
    public static class TestConfig {
        /// Referencia a configuração da dataSource
        public static final String test_data_source_properties_ref = "testDataSourceProperties";
        /// Referencia a criação do datasource
        public static final String test_data_source_ref = "testDataSource";

        /// Referencia ao manager de entidades
        public static final String test_entity_manager_factory_ref = "testEntityManagerFactory";
        /// Referencia ao manager de transações
        public static final String test_transaction_manager_ref = "testTransactionManager";
    }
